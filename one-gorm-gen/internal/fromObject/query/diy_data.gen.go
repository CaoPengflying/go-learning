...
func newData(db *gorm.DB, opts ...gen.DOOption) data {
	...
	_data.UserInfo = field.NewField(tableName, "userinfo")
	_data.Remark = field.NewBytes(tableName, "remark")
...
func (d *data) updateTableName(table string) *data {
	...
	d.UserInfo = field.NewField(table, "userinfo")
	d.Remark = field.NewBytes(table, "remark")
...
func (d data) Columns(cols ...field.Expr) gen.Columns { return d.dataDo.Columns(cols...) }
...
func (d *data) fillFieldMap() {
	...
	d.fieldMap["id"] = d.ID
	d.fieldMap["userinfo"] = d.UserInfo
