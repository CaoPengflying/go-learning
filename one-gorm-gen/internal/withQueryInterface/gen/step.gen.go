...
func (s *step) WithContext(ctx context.Context) IStepDo { return s.stepDo.WithContext(ctx) }
...
type IStepDo interface {
	...
	Unscoped() IStepDo
	Create(values ...*model.Step) error
	CreateInBatches(values []*model.Step, batchSize int) error
	Save(values ...*model.Step) error
	First() (*model.Step, error)
	Take() (*model.Step, error)
	Last() (*model.Step, error)
	Find() ([]*model.Step, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*model.Step, err error)
	FindInBatches(result *[]*model.Step, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*model.Step) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*model.Step, error)
	FirstOrCreate() (*model.Step, error)
	FindByPage(offset int, limit int) (result []*model.Step, count int64, err error)
