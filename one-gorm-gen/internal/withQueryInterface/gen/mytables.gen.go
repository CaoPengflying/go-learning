...
func (m *mytable) WithContext(ctx context.Context) IMytableDo { return m.mytableDo.WithContext(ctx) }

func (m mytable) TableName() string { return m.mytableDo.TableName() }

func (m mytable) Alias() string { return m.mytableDo.Alias() }

func (m mytable) Columns(cols ...field.Expr) gen.Columns { return m.mytableDo.Columns(cols...) }
...
type IMytableDo interface {
	...
	TestTrim(list []string) (result []model.Mytable)
	TestTrimInWhere(list []string) (result []model.Mytable)
	TestInsert(data map[string]interface{}) (err error)
	FindByID(id int) (result model.Mytable)
	LikeSearch(name string) (result *model.Mytable)
	InSearch(names []string) (result []*model.Mytable)
	ColumnSearch(name string, names []string) (result []*model.Mytable)
}
...
// {{end}}
// {{end}}
func (m mytableDo) TestTrim(list []string) (result []model.Mytable) {
	var params []interface{}

	var generateSQL strings.Builder
	generateSQL.WriteString("select * from mytables where ")
...
// {{end}}
// {{end}}
func (m mytableDo) TestTrimInWhere(list []string) (result []model.Mytable) {
	var params []interface{}

	var generateSQL strings.Builder
	generateSQL.WriteString("select * from mytables ")
...
// {{end}}
// {{end}}
func (m mytableDo) TestInsert(data map[string]interface{}) (err error) {
	var params []interface{}
...
func (m mytableDo) FindByID(id int) (result model.Mytable) {
	var params []interface{}
...
func (m mytableDo) LikeSearch(name string) (result *model.Mytable) {
	var params []interface{}

	var generateSQL strings.Builder
	params = append(params, name)
	generateSQL.WriteString("SELECT * FROM mytables where name LIKE concat('%',?,'%') ")
...
func (m mytableDo) InSearch(names []string) (result []*model.Mytable) {
	var params []interface{}

	var generateSQL strings.Builder
	params = append(params, names)
	generateSQL.WriteString("select * from mytables where name in ? ")
...
//
// select * from @@table where @@name in @names
func (m mytableDo) ColumnSearch(name string, names []string) (result []*model.Mytable) {
	var params []interface{}

	var generateSQL strings.Builder
	params = append(params, names)
	generateSQL.WriteString("select * from mytables where " + m.Quote(name) + " in ? ")
