...
type Plugin struct {
	...
	PluginName   string    `gorm:"column:plugin_name;not null" json:"pluginName"`
	Status       int32     `gorm:"column:status;not null;default:1;comment:表明插件目前的状态:1创建中、2已完成、-1已删除" json:"status"`     // 表明插件目前的状态:1创建中、2已完成、-1已删除
	StepID       int32     `gorm:"column:step_id;not null;comment:插件可以在哪一步骤使用" json:"stepId"`                            // 插件可以在哪一步骤使用
	...
	ModelIds     string    `gorm:"column:model_ids;not null;comment:模型ids" json:"modelIds"`                              // 模型ids
